<x-app-layout>
    ...
    <main class="w-full">
                ...
                <div class="relative w-full">
                    ...
                    <div class="p-8 border-2 w-80 mt-16 mb-6 mx-auto">
                        ...
                        <div class="flex mb-5 ">
                            ...
                            <p class="p-2 text-lg text-custom-blue font-semibold"> : {{$event->partners}}</p>
                        </div>
                        <div class="flex mb-5">
                            <svg version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="w-9 mr-2" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve" fill="#701a75">
                                <g id="SVGRepo_bgCarrier" stroke-width="0" />
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" />
                                <g id="SVGRepo_iconCarrier">
                                    <g>
                            ...
                            <p class="p-2 text-lg text-custom-blue">{{$event->description}}</p>
                        </div>
                        <div class="flex mb-5">
                            ...
                            <p class="p-2 text-lg text-custom-blue font-semibold"> {{$event->status->name}}</p>
                        </div>
                        <div class="flex mb-5">
                            ...
                            <p class="p-2 text-lg text-custom-blue font-semibold"> {{$event->number_of_participants->name}}</p>
                        </div>
                        <div class="flex mb-5">
                        ...
                        <div class="flex mb-5">
                            <svg class="w-9 mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0" />
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" />
                                <g id="SVGRepo_iconCarrier">
                                ...
                                <div class="bg-custom-purple rounded-lg w-1/2 p-4">
                                    <div class="p-6">
                                        ...
                                        <div class="flex justify-end">
                                            <button type="button" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded mr-2" data-dismiss="modal">Annuler</button>
                    ...
                    @isset($dateStart)
                    <p class="absolute top-0 left-0 p-2 ">{{ $dateStart }}</p>
                    <hr class="absolute top-10 left-4 p-2 w-1/15 border-gray-300 dark:border-gray-700">
                    @endisset
                    @endforeach
                </div>
                @endif
        ...
        <script>
            ...
            //Onclick delete button -> display popup 
