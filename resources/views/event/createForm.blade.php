        ...
        <form action="{{ route('userEvent.add') }}" method="POST" class="bg-gray-100 block p-8 rounded-2xl w-3/4 justify-center mx-auto mt-8 mb-6">
            ...
            <section class="relative border-2 border-custom-purple rounded-lg p-16 mb-12 ">
                ...
                <div class="flex flex-col mb-4">
                    ...
                    <input class="bg-white border border-gray-300 text-gray-900 text-l rounded-lg p-2 @error('name') is-invalid @enderror" name="name" type="text" value="{{ old('name') }}">
                </div>
                ...
                <div class="w-full flex place-content-between mb-4">
                    ...
                    <div class="flex flex-col w-3/5 mb-4">
                        ...
                        <input name="partners" class="bg-white border border-gray-300 text-gray-900 text-l rounded-lg p-2" type="text" value="{{ old('partners') }}">
                    </div>
                </div>

                <div class="flex flex-col mb-8">
                    <label class="mb-3 text-xl" for="description">Description courte de l'événement :</label>
                    <textarea class="bg-white border border-gray-300 text-gray-900 text-l rounded-lg p-2 w-3/5" name="description" id="" cols="10" rows="1"></textarea>
                </div>
            ...
            <section class="relative border-2 border-custom-purple rounded-lg p-16 mb-12 ">
                ...
                <div class="flex flex-col w-2/5 mr-8">
                    ...
                    @error('name')<span class="text-red-600">{{ $message }}</span>@enderror
                    <input class="bg-white border border-gray-300 text-gray-900 text-l rounded-lg p-2 mb-6 @error('location') is-invalid @enderror" name="location" type="text" value="{{ old('location') }}">
                </div>
