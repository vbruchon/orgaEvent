...
<form id="filterbar" action="{{ route($route) }}" method="get" class="p-8">
    @csrf
    ...
    <div class="flex flex-col mb-4">
        ...
        <select class="bg-white border border-custom-purple text-gray-900 text-l rounded-lg p-2.5 w-5/6" name="status" id="status">
    ...
    <div class="flex flex-col mb-4">
        ...
        <select class="bg-white border border-custom-purple text-gray-900 text-l rounded-lg p-2.5 w-5/6 @error('nbre_people') is-invalid @enderror" id="participants" name="number_of_participants">
